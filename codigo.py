...
arquivo = open("/home/carlosdaniel/PYTHON-folder-main/terceiro-ano/case_sensitive/original.txt", "r")
...
arquivo = open("/home/carlosdaniel/PYTHON-folder-main/terceiro-ano/case_sensitive/chave.txt", "r")
chaves = arquivo.read()
arquivo.close
...
arquivo = open("/home/carlosdaniel/PYTHON-folder-main/terceiro-ano/case_sensitive/cifrado.txt", "w", encoding = "utf-8")
arquivo.write(cifragem)
arquivo.close()

#Decifrando a mensagem do 'cifrado.txt' e escrevendo no 'decifrado.txt'
arquivo = open("/home/carlosdaniel/PYTHON-folder-main/terceiro-ano/case_sensitive/cifrado.txt", "r")
criptografada = arquivo.read()
arquivo.close()

decifragem = cifragem.translate(tabela_chaves)

#Abrindo o arquivo 'decifrado.txt' e escrevendo o resultado final (precisa ser igual a mensagem original)
arquivo = open("/home/carlosdaniel/PYTHON-folder-main/terceiro-ano/case_sensitive/decifrado.txt", "w", encoding = "utf-8")
